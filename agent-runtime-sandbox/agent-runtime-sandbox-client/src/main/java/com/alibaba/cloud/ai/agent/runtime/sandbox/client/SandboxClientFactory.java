...
public class SandboxClientFactory {
	 ...
	 * Constructor
	 */
	public SandboxClientFactory(String managerBaseUrl, String authToken) {
		this.managerClient = new SandboxManagerClient(managerBaseUrl, authToken);
	}

	/**
	 * Create a new sandbox session
	 */
	public SandboxSession createSession(SandboxType sandboxType) throws SandboxClientException {
	 ...
	 */
	public SandboxSession createSession(SandboxType sandboxType, String sessionId) throws SandboxClientException {
	 ...
	 */
	public SandboxSession getSession(String sessionId) throws SandboxClientException {
	 ...
	 * Wait for container to be ready
	 */
	private void waitForContainerReady(ContainerModel container) throws SandboxClientException {
	...
	public void close() {
		try {
			...
			logger.error("Failed to close manager client", e);
		}
	}
