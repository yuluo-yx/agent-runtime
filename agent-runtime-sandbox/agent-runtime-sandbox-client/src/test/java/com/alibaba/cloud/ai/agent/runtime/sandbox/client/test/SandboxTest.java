package com.alibaba.cloud.ai.agent.runtime.sandbox.client.test;

import com.alibaba.cloud.ai.agent.runtime.sandbox.client.SandboxClientException;
import com.alibaba.cloud.ai.agent.runtime.sandbox.client.SandboxClientFactory;
import com.alibaba.cloud.ai.agent.runtime.sandbox.client.SandboxSession;
...
public class SandboxTest {
	...
	public static void main(String[] args) throws SandboxClientException {
		// Configuration
		String managerUrl = "http://localhost:8080";
		String authToken = "dev-token-123";

		// Create sandbox client factory
		SandboxClientFactory factory = new SandboxClientFactory(managerUrl, authToken);
