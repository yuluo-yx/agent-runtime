...
package com.alibaba.cloud.ai.agent.runtime.sandbox.core.exceptions;

/**
 * Exception thrown by sandbox client operations
 */
public class SandboxClientException extends RuntimeException {
	...
	public SandboxClientException(Throwable cause) {
		super(cause);
	}
